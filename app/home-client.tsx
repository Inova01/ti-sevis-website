    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#accueil" aria-label="Ti Sèvis — Accueil" onClick={() => setMenuOpen(false)}>
          <span className="brand-mark" aria-hidden="true"><img src={assetPath('/ti-sevis-logo.jpeg')} alt="" /></span>
      ...
      <footer>
        <div className="footer-main">
          <div className="footer-brand"><a className="brand inverse" href="#accueil"><span className="brand-mark" aria-hidden="true"><img src={assetPath('/ti-sevis-logo.jpeg')} alt="" /></span><span>TI <strong>SÈVIS</strong></span></a><p>{t.footerLine}</p><a href="mailto:bonjour@tisevis.ht"><Mail size={16} /> bonjour@tisevis.ht</a></div>
